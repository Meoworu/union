...
const useAnalyzerPlugin = process.env.ANALZY_ENV === 'true';
          ...
          postcssOptions: {
            ...
            plugins: [
              ...
              [
                'postcss-pxtorem',
                {
                  rootValue: 192, // 表示根元素html的fontSize值为设计稿width/10默认ui搞宽度为1920，通常为750
                  propList: ['*'], // 设置px转换成rem的属性值，*表示所有属性的px转换为rem
                  minPixelValue: 2, // 最小转换的数值
                  // exclude: /xiaobing-PC/, 不转换的文件
                },
              ],
            ].filter(Boolean),
          },
